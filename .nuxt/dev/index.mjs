globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/scule/dist/index.mjs';
import { hash } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/ufo/dist/index.mjs';
import { createStorage } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/learning/Desktop/learning/JS-calculator/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/learning/Desktop/learning/JS-calculator/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/learning/Desktop/learning/JS-calculator","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/learning/Desktop/learning/JS-calculator/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/learning/Desktop/learning/JS-calculator/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/learning/Desktop/learning/JS-calculator/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_UofaJP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UofaJP, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UofaJP, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/learning/Desktop/learning/JS-calculator/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/learning/Desktop/learning/JS-calculator/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
